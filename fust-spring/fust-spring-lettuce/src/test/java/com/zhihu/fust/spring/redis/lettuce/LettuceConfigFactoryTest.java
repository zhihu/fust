...
class LettuceConfigFactoryTest {
    static RedisServer server;
    static int port = 16781;
    ...
    void createJedisPool() {
        LettuceConfigFactory factory = getLettuceConfigFactory();
    ...
    private static LettuceConfigFactory getLettuceConfigFactory() {
        ...
        return new LettuceConfigFactory(props);
    }
}