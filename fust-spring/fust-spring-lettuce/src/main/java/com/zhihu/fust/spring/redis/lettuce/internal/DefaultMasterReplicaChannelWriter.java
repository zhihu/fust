...
public class DefaultMasterReplicaChannelWriter implements RedisChannelWriter {

    private DefaultLettuceConnectionProvider<?, ?> masterSlaveConnectionProvider;
    private final ClientResources clientResources;

    private boolean closed = false;
    private boolean inTransaction;

    DefaultMasterReplicaChannelWriter(DefaultLettuceConnectionProvider<?, ?> masterSlaveConnectionProvider,
    ...
    public <K, V, T> RedisCommand<K, V, T> write(RedisCommand<K, V, T> command) {
        ...
        CompletableFuture<StatefulRedisConnection<K, V>> future =
                (CompletableFuture) masterSlaveConnectionProvider
    ...
    @SuppressWarnings("unchecked")
    private static <K, V> void writeCommand(RedisCommand<K, V, ?> command,
    ...
    private static Intent getIntent(ProtocolKeyword type) {
        return DefaultReadOnlyCommands.isReadOnlyCommand(type) ? Intent.READ : Intent.WRITE;
    }
    ...
    DefaultLettuceConnectionProvider<?, ?> getMasterSlaveConnectionProvider() {
